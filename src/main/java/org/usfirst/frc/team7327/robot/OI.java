...
public class OI{
    ...
    public boolean LeftBumper     (int x){ Remote(x); return control.getBumperPressed(Hand.kLeft); }
    public boolean LeftBumperDown (int x){ Remote(x); return control.getBumper(Hand.kLeft); }
    public boolean RightBumper    (int x){ Remote(x); return control.getBumperPressed(Hand.kRight); }
    public boolean RightBumperDown(int x){ Remote(x); return control.getBumper(Hand.kRight); }
    ...
    public boolean LSClick        (int x){ Remote(x); return control.getStickButtonPressed(Hand.kLeft); }
    public boolean RSClick        (int x){ Remote(x); return control.getStickButtonPressed(Hand.kRight); }
    public boolean LSClickDown    (int x){ Remote(x); return control.getStickButton(Hand.kLeft); }
    public boolean RSClickDown    (int x){ Remote(x); return control.getStickButton(Hand.kRight); }
